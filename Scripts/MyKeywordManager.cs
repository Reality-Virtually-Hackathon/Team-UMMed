...
namespace HoloToolkit.Unity.InputModule
{
    ...
    /// </summary>
    public partial class MyKeywordManager : MonoBehaviour
    {
        [System.Serializable]
        ...
        void Start()
        {
            ...
            if (keywordCount > 0)
            {
                try
                {
                    ...
                    string[] keywords = new string[] { "reset", "reset world", "restart", "next",
                    "open", "separate", "apart", "separation",
                    "close", "joint", "joined", "together", "join", "assembly", "group",
                    "bigger","smaller","turn left","turn right","move left","move right","move up","move down","move forward","move backward" };
