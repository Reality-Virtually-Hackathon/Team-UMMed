...
/// </summary>
public class Hold2ScaleParent : MonoBehaviour,
                                 IFocusable,
                                 IInputHandler,
                                 ISourceStateHandler,
                                 IInputClickHandler
{
    ...
    private void UpdateDragging()
    {
        ...
        // Apply Final Position to parent
        HostTransform.transform.parent.position = draggingPosition + mainCamera.transform.TransformDirection(objRefGrabPoint);
        log(HostTransform.transform.parent.position.ToString());
