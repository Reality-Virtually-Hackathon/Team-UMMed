...
public class Hold2Move : MonoBehaviour, IInputHandler, IInputClickHandler, IFocusable, IManipulationHandler
{
    ...
    public void OnManipulationUpdated(ManipulationEventData eventData)
    {
        ...
        var pos = new Vector3(eventData.CumulativeDelta.y * -multiplier, eventData.CumulativeDelta.x * multiplier);
        //transform.localPosition = pos; // * Speed, Space.World);
        //transform.position += (Camera.main.transform.rotation * GestureManager.Instance.NavigationPosition) ;
