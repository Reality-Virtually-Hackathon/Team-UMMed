...
/// </summary>
public class SelectBuildControllerAndGraggable : MonoBehaviour,
                                 IFocusable,
                                 IInputHandler,
                                 ISourceStateHandler,
                                 IInputClickHandler,
                                 IManipulationHandler, ISpeechHandler
{
    ...
    private void Start()
        ...
        public void DrawSelectionBox()
        {
            ...
            //CreateEndPointsCube(sarPoint1 + ControllerObject.transform.localPosition, transparentMaterial);
